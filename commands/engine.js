...
{
	let group = { Command: 'engine', Does: 'compute', Describe: 'Query, sort, project, update and validate documents with jsongin, with no file and no storage.', Concurrent: true, Commands: [] };
	let groups = {};
